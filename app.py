...
st.title("Hi there, are you wondering if an online post/headline is real or fake? Airton developed this machined learning web app to help guide you")
st.header("We;ll make this prediction by comparing any given headline or text to thousands of other social media posts.")
st.subheader("If the model classifies the given headline or post as something that would be observable is a 'worldnews' subreddit, it is likely trustworthy and will assign a percentage likelihood with its prediction, otherwise it'll  classify the text as 'conspiracy' and assign a similar probability.")
